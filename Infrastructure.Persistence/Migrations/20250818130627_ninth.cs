        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionLogs_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceTransactionId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionLogs_RelatedEntity_EntityId",
                table: "TransactionLogs",
                columns: new[] { "RelatedEntity", "EntityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionLogs_TrackingCode",
                table: "TransactionLogs",
                column: "TrackingCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionLogs_UserId1",
                table: "TransactionLogs",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_TrackingCode",
